...
class GameState
    ...
    STAGES = {
        0 => {
            text: "THE RIVER OF DOUBT INTERACTIVE ADVENTURE\nYou will be given the ability to make the choices of Teddy Roosevelt on his journey through the River of Doubt and see if you can do better than he did!\nYou will need to manage your resources and conditions carefully, as the jungle is unforgiving... Good luck!",
            bg: 'rod_cover2.jpg',
            options: [ 
        ...
        10 => {
            text: "Since you were able to conduct some research and collect specimens, people can see the physical proof of your expedition!...\nAchievement: Canon Ending",
            bg: 'escaped_good.jpg',
            options: [
    ...
    def self.update_display
        ...
        if @stage == 99
            @current_objs << Image.new('transition_bg.jpg')
    ...
    def self.handle_choice(action)
        ...
        when 's3_leave'
            @morale -= 20
            show_transition("Causing a commotion, the group decides to hurriedly pack their stuff and move to a new area. The group is safe for now, but the weight of the danger still looms.\n\nMorale -20", 4)
