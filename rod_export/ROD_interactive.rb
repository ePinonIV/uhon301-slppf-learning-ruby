    ...
    def self.handle_choice(action)
        ...
        when 's5_medicine'
            if @resources > 0
                ...
                @health -= 50
                @hunger -= 20
                show_transition("The group checks for medicine, but they have fully run out of resources, so they must tough out the illnesses the hard way.\n\nHealth -40\nHunger-20 ", 6)
            end
        when 's5_pass'
            @health -= 50
            @hunger -= 20
        ...
        when 'eat'
            ...
            if @status_check == 0
                @current_objs << Text.new("Hunger will be updated on next stage", x: 1120, y: 900, size: 22, color: 'lime', z: 10)
                @status_check == 1
            end
        ...
        when 'heal'
            ...
            if @status_check == 0
                @current_objs << Text.new("Health will be updated on next stage", x: 1120, y: 930, size: 22, color: 'lime', z: 10)
                @status_check == 1
            end
        ...
        when 'socialize'
            ...
            if @status_check == 0
                @current_objs << Text.new("Morale will be updated on next stage", x: 1120, y: 960, size: 22, color: 'lime', z: 10)
                @status_check == 1
            end
        ...
        when 'research'
            ...
            @research += 10
            if @status_check == 0
                @current_objs << Text.new("Research will be updated on next stage", x: 1120, y: 990, size: 22, color: 'lime', z: 10)
                @status_check == 1
            end
